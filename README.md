...
4. Configure timeout de 7 segundos e memória de 256 MB. A chamada OpenAI tem timeout próprio de 5,5 segundos para sobrar tempo à Alexa responder um erro amigável.
